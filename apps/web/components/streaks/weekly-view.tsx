      ...
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[600px]">
            <thead>
              <tr>
                <th className="text-left font-mono text-[10px] text-[var(--editorial-text-dim)] font-normal pb-4 pr-4">
                  Habit
                </th>
                ...
                <th className="text-center font-mono text-[10px] text-[var(--editorial-text-dim)] font-normal pb-4 pl-4">
                  Streak
                </th>
              </tr>
            </thead>
                ...
                return (
                  ...
                  >
                          ...
                          <div className="flex justify-center">
                            <button
                              ...
                              className={`w-8 h-8 transition-all ${
                                isFuture
                                  ? "border border-[var(--editorial-border)] cursor-not-allowed opacity-50"
                                  : `${getLevelColor(level)} hover:ring-1 hover:ring-[var(--editorial-text)]/50 cursor-pointer`
                    ...
                    <td className="py-3 pl-4">
                      <div className="flex justify-center">
                        <span className="text-xs font-mono text-[var(--editorial-text-muted)]">
                          {streak}d
                        </span>
                      </div>
                    </td>
