  ...
  return (
    <footer className="w-full shrink-0 border-t border-[var(--editorial-border)] bg-[var(--editorial-surface)]">
      <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 font-mono text-[10px] uppercase text-[var(--editorial-text-muted)]">
          <a
            href="/rss.xml"
            className="hover:text-[var(--editorial-accent)] transition-colors"
          >
            RSS Feed
          </a>
          ...
          <button
            type="button"
            onClick={scrollToTop}
            className="text-[var(--editorial-accent)] hover:underline bg-transparent border-0 p-0 font-mono text-[10px] uppercase cursor-pointer"
          >
            Back to top ↑
          </button>
        </div>
